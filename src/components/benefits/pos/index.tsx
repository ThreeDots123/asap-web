...
const businessBenefits = [
  "Portable and Flexible with Zero Hardware Cost",
    ...
    >
      ...
      <div className="layout-container py-10 relative z-1">
        <div className="text-primary-light flex items-center gap-2">
          <BusinessIcon />
          <h5 className="text-xs">ASAP MOBILE POS</h5>
        </div>
            ...
            <div className="relative w-fit mx-auto max-w-3xl pt-2 lg:pt-10 pb-8 lg:pb-20 max-lg:text-white">
              <div className="mb-4 flex items-center gap-3">
                ...
                <h2 className="text-4xl tracking-[-4%] font-bold lg:text-[#3D3D3D] uppercase font-heading">
                  Your Store, Anywhere. Accept Crypto Payments in Seconds.
                </h2>
              </div>
              <p className="lg:text-[#3D3D3D] text-white text-sm mt-8">
                ASAP Mobile POS gives your business two powerful ways to collect crypto
                payments; in-store with traditonal POS machine or in-app with our mobile app
                Turn your smartphone or tablet into a powerful, portable payment terminal. 
                With ASAP Mobile POS, meet your customers wherever they are: at a market stall, 
                a pop-up event, or in your store. Simply generate a payment QR code, 
                let your customer scan it with their crypto wallet, and receive instant confirmation. 
                No bulky hardware, no complex setups. We handle the conversion and compliance in the background, 
                so you get paid in cash, on the spot. Perfect for retail, hospitality, services, and on-the-go entrepreneurs.
              </p>
